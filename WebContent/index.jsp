...
<body>
    ...
    <div class="container mt-3 p-0">
      ...
      <%
      	List<Categorize> categorizes = (List<Categorize>)request.getAttribute("categorizes");
      	for (Categorize categorize : categorizes) {
      %>
          <div class="card hvr-grow-shadow m-2 " style="width: 150px; height: 150px; background-color: #fff; border-radius: 25px; cursor:pointer;" onclick="window.location.href='goods?type=<%=categorize.getId() %>'">
            <img src="<%=basePath%><%=categorize.getImg() %>" class="card-img-top mt-3 mx-auto d-block" alt="..." style="width: 92px;">
            <div class="card-body mt-0 p-1">
              <p class="card-text text-center" style="font-size: large;"><%=categorize.getName() %></p>
            </div>
          </div>
      <%
      	}
